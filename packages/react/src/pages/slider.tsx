      ...
      <Wrapper>
        <div className="flex flex-col gap-20">
          <div>
            <Title>Slider</Title>
            <Subtitle>
              A draggable control that lets users pick a value by sliding left
              or right.
            </Subtitle>
            <div className="flex gap-3 mt-5">
              <ApiButton
                target="_blank"
                href="https://zagjs.com/components/react/slider"
              >
                Docs <MoveUpRight className="stroke-1 size-3" />
              </ApiButton>
              <ApiButton
                target="_blank"
                href="https://zagjs.com/components/react/slider#methods-and-properties"
              >
