      ...
      <div className="grid sm:grid-cols-2">
        ...
        <div className="justify-center items-center flex gap-2 border-b border-e border-foreground/10 p-5 flex-wrap">
          <AccordionRoot
            ...
            defaultValue={["product-information"]}
          >
            <AccordionItem asChild value="product-information">
              <Box raised="single" className="py-0">
                <AccordionTrigger>Product Information</AccordionTrigger>
                <AccordionContent>
                  <p className="mb-2">
                    Our flagship product combines cutting-edge technology with
            ...
            <AccordionItem asChild value="shipping-details">
              <Box raised="single" className="py-0">
                <AccordionTrigger>Shipping Details</AccordionTrigger>
                <AccordionContent>
                  <p className="mb-2">
            ...
            <AccordionItem asChild value="return-policy">
              <Box raised="single" className="py-0">
                <AccordionTrigger>Return Policy</AccordionTrigger>
                <AccordionContent>
                  <p className="mb-2">
