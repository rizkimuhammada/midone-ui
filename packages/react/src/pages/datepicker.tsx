      ...
      <Wrapper>
        <div className="flex flex-col gap-20">
          <div>
            ...
            <Subtitle>
              A simple calendar tool that helps users pick dates quickly and
              accurately.
            </Subtitle>
            <div className="flex gap-3 mt-5">
              <ApiButton
                target="_blank"
                href="https://zagjs.com/components/react/datepicker"
              >
                Docs <MoveUpRight className="stroke-1 size-3" />
              </ApiButton>
              <ApiButton
                target="_blank"
                href="https://zagjs.com/components/react/datepicker#methods-mnd-eoop-atipsroperties"
              >
      ...
      <DatePickerView view="year">
        <DatePickerContext>
          ...
          <div id="installation">
            ...
            <InstallPackage>
              add @zag-js/react @zag-js/datepicker
            </InstallPackage>
            <SectionContent>
