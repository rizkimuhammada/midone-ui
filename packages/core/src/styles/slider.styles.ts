export const sliderRoot = "w-full flex flex-col gap-3";
export const sliderLabel = "";
export const sliderValueText = "text-xs font-medium flex justify-center";
...
export const sliderMarker = [
  "text-xs opacity-80 relative mt-3.5",
  "before:size-1 before:absolute before:inset-0 before:rounded-full before:bg-foreground/40 before:mx-auto before:-mt-3",
];
