...
export const paginationItem = [
  ...
  "data-[selected]:border data-[selected]:bg-background data-[selected]:bg-foreground/10 data-[selected]:border-(--color-foreground)/10 data-[selected]:font-medium data-[selected]:shadow-md/5",
