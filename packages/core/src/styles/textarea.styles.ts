export const textarea = [
  "placeholder:text-foreground/70 selection:bg-foreground/80 selection:text-background flex field-sizing-content min-h-16 w-full rounded-xl border border-foreground/20 bg-background px-3 py-2 text-base shadow-sm transition-[color,box-shadow] outline-none focus-visible:ring-[3px] disabled:cursor-not-allowed disabled:opacity-50 md:text-sm",
