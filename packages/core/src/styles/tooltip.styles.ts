...
export const tooltipArrowTip = [
  ...
  "before:absolute before:inset-0 before:bg-background dark:before:bg-foreground/15 before:rounded-tl-sm before:border-s before:border-t before:border-foreground/15",
];
