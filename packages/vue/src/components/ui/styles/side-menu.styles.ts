...
export const sideMenuInner =
  "side-menu__content z-20 relative duration-300 transition-[width] h-screen flex w-[var(--sm-width)] group-[[data-compact-menu=true]]:xl:w-[var(--sm-collapsed-width)] group-[[data-compact-menu=true][data-compact-menu-on-hover=true]]:xl:w-[var(--sm-width)]";
...
export const sideMenuTopBar =
  "top-bar group z-50 relative [&[data-scrolled=true]]:sticky [&[data-scrolled=true]]:inset-x-0 [&[data-scrolled=true]]:top-0 [&[data-scrolled=true]]:z-[999] [&[data-scrolled=true]]:mt-0";

export const sideMenuTopBarInner =
  "flex h-16 items-center gap-5 border-b border-foreground/15 transition-all group-[[data-scrolled=true]]:px-5 group-[[data-scrolled=true]]:rounded-2xl group-[[data-scrolled=true]]:bg-background group-[[data-scrolled=true]]:border group-[[data-scrolled=true]]:shadow-lg group-[[data-scrolled=true]]:shadow-foreground/5 group-[[data-scrolled=true]]:dark:bg-dark-2";
