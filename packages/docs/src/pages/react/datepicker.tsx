...
<DatePickerRoot label="Basic" className="w-84" />
      ...
      <div id="installation">
        ...
        <InstallPackage>add @zag-js/react @zag-js/datepicker</InstallPackage>
        <SectionContent>
          Copy and paste the following code into your project.
        </SectionContent>
        <PreviewCode title="components/ui/datepicker/index.tsx">
          {`
          ...
          <div>
            {!children ? (
              <>
                <DatePickerYearSelect />
                <DatePickerMonthSelect />
                <DatePickerView view="day" isManual={false}>
                  <DatePickerContext>
                    {(api) => (
                      <>
                        <DatePickerViewControl>
                ...
                <DatePickerView view="month" isManual={false}>
                  <DatePickerContext>
                    {(api) => (
                      <>
                        <DatePickerViewControl>
                ...
                <DatePickerView view="year" isManual={false}>
                  <DatePickerContext>
                    {(api) => (
                      <>
                        <DatePickerViewControl>
...
/>
        ...
        <Preview>
          {() => ({
            preview: (
              <>
                <DatePickerRoot withTrigger={true} label="With Trigger" className="w-84" />
              </>
            ),
            code: (
              <PreviewCode>
          ...
          {() => ({
            preview: (
              <div className="flex flex-col items-center">
                <DatePickerRoot open>
                  <DatePickerInput className="w-84" />
                </DatePickerRoot>
              </div>
            ),
            code: (
