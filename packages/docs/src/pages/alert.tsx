      ...
      <Wrapper>
        <div className="flex flex-col gap-20">
          <div>
            <Title>Alert</Title>
            <Subtitle>
              A quick message box that helps you highlight important info or
              warnings for your users.
            </Subtitle>
            <div className="flex gap-3 mt-5">
              <ApiButton
                target="_blank"
                href="https://zagjs.com/components/react/alert"
              >
                Docs <MoveUpRight className="stroke-1 size-3" />
              </ApiButton>
              <ApiButton
                target="_blank"
                href="https://zagjs.com/components/react/alert#methods-and-properties"
              >
