...
class PageConverterController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->docsPath           = $root . '/packages/docs/src/pages';
        ...
        if (!empty(trim($mainBody))) {
            ...
            if (!empty($matches)) {
                ...
                foreach ($matches as $match) {
                    ...
                    $initialValue = ($initial === '[]') ? '[] as unknown[]' : $initial;
                    $declarations .= "const {$stateVar} = {$initialValue};\n";
                    $declarations .= "const {$setterVar} = (..._args: unknown[]) => {};\n";
                }
            }
        }
